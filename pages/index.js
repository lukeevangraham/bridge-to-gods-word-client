    ...
    <Layout global={globalData}>
      <div>
        ...
        <main className={classes.main}>
          ...
          <div className={classes.lowerSections}>
            <section className={classes.lowerSections__latestBlog}>
              <div className="row">
                <h2 className={classes.mobileOnly}>
                  Latest Blog
                </h2>
                <div className={classes.lowerSections__latestBlog__container}>
                  <Fade bottom>
                    <div
                      className={
                        classes.lowerSections__latestBlog__container__text
                      }
                    >
                      <h2 className={classes.desktopOnly}>
                        Latest Blog
                      </h2>
                      ...
                      <div
                        className={
                          classes.lowerSections__latestBlog__container__text__dateAndExcerpt
                        }
                      >
                        <DateBox date={latestBlog.DatePosted} />
                        <div
                          className={
                            classes.lowerSections__latestBlog__container__text__dateAndExcerpt__excerpt
                          }
                        >
                      ...
                      <div
                        className={
                          classes.lowerSections__latestBlog__container__text__topics
                        }
                      >
                      ...
                      <div
                        className={
                          classes.lowerSections__latestBlog__container__text__otherPosts
                        }
                      >
                        <h4>
                          <Link href="/blog">
                  ...
                  <div
                    className={
                      classes.lowerSections__latestBlog__container__image
                    }
                  >
                    <Link href={`/blog/${latestBlog.slug}`}>
                      <a>
            ...
            <section className={classes.lowerSections__Podcast}>
              <div className="row">
                <h2 className={classes.mobileOnly}>
                  Latest Podcast
                </h2>
                <div className={classes.lowerSections__Podcast__container}>
                  <Fade bottom>
                    <div
                      className={
                        classes.lowerSections__Podcast__container__text
                      }
                    >
                      <h2 className={classes.desktopOnly}>
                        Latest Podcast
                      ...
                      <div
                        className={
                          classes.lowerSections__Podcast__container__text__dateAndExcerpt
                        }
                      >
                        <DateBox
            ...
            <section className={classes.lowerSections__Newsletter}>
              <div className="row">
                <h2 className={classes.mobileOnly}>
                  Latest Newsletter
                </h2>
                <div className={classes.lowerSections__Newsletter__container}>
                  <Fade bottom>
                    <div
                      className={
                        classes.lowerSections__Newsletter__container__text
                      }
                    >
                      <h2 className={classes.desktopOnly}>
                        Latest Newsletter
                      ...
                      <div
                        className={
                          classes.lowerSections__Newsletter__container__text__dateAndExcerpt
                        }
                      >
                        <DateBox date={newsletter.date} />
                        <div
                          className={
                            classes.lowerSections__Newsletter__container__text__dateAndExcerpt__excerpt
                          }
                        >
                      ...
                      <div
                        className={
                          classes.lowerSections__Newsletter__container__text__otherPosts
                        }
                      >
                        <h4>
